...
tags: AI, Models, Regulation, Hardware, Funding, Cybersecurity, Enterprise, Open Source
slug: ai-news-august-4-qwen-38-max-white-house-safety-olix-photonics
---
...
*Sources: [Bloomberg](https://www.bloomberg.com/news/articles/2026-08-03/alibaba-drops-another-china-ai-model-with-breakthrough-performance), [Quartz](https://qz.com/alibaba-qwen38-max-ai-model-launch-080326), [MarkTechPost](https://www.marktechpost.com/2026/08/03/alibaba-qwen-releases-qwen3-8-max/)*
...
*Sources: [Axios](https://axios.com), [Reuters via The Daily Guardian](https://thedailyguardian.com/news/science-tech/meta-anthropic-google-openai-to-meet-trump-officials-about-ai-safety-testing-744593/), [Bloomberg](https://www.bloomberg.com/news/articles/2026-08-03/openai-anthropic-google-to-join-white-house-ai-safety-meeting)*
...
*Sources: [The Hill](https://thehill.com)*
...
*Sources: [CBS News](https://cbsnews.com)*
...
*Sources: [Las Vegas Sun](https://lasvegassun.com)*
...
*Sources: [AI Weekly](https://aiweekly.co/ai-news-today), [Hugging Face](https://huggingface.co)*
...
*Sources: [TestingCatalog](https://testingcatalog.com)*
...
*Sources: [AI Weekly](https://aiweekly.co/ai-news-today), [Comfy.org](https://blog.comfy.org)*
...
Critics say the moratorium lacks legislative teeth and Abbott's order doesn't spell out enforcement, but any slowdown in Texas — the busiest US data-center growth market — would ripple through hyperscaler siting plans. The move follows similar data-center scrutiny in [four US states that repealed tax breaks](/blog/ai-news-august-3-apple-ai-bug-flood-tax-breaks-dna-tampering-openai-safety) just yesterday.

*Sources: [Texas Tribune](https://texastribune.org)*
...
The ban reflects a growing European concern that AI tools designed for adults are being adopted by children without adequate safeguards. While the EU AI Act's [high-risk obligations became enforceable on August 2](/blog/ai-news-august-2-eu-ai-act-california-astra), Norway's move is more targeted and immediate — a practical response to what teachers are seeing in classrooms right now.

*Sources: [MemeBurn](https://memeburn.com/norway-blocks-ai-for-elementary-students-starting-august-2026/)*
...
*Sources: [CrowdStrike](https://crowdstrike.com)*
...
*Sources: [The Next Web](https://thenextweb.com)*
...
The talent dynamics are shifting rapidly. With Anthropic's [Series H $65 billion raise at $965 billion valuation](/blog/ai-daily-roundup-2026-07-25) and Meta's [AI capex floor raised to $130 billion](https://investor.atmeta.com), the financial incentives to jump ship have never been higher. Amodei's warning is a signal that even the best-funded AI labs are struggling to retain the people who actually build the models.

*Sources: [Axios](https://axios.com)*
